...
<body>
	...
	<header class="header">
		<div class="container">
			<h3 class="header__title">Подтверждение заказа</h3>
		</div>
	</header>

	<main class="main">
		<div class="container">
			<h1 class="main__title">Спасибо за ваш заказ!</h1>
			<div class="main__content">
				<div class="main__top">
					<div class="main__top-items">
						<div class="main__top-item">
							<p class="main__top-text">Ваше имя:</p>
							<span class="main__name" id="name"><?php echo ($name)?></span>
						</div>
						<div class="main__top-item">
							<p class="main__top-text">Ваш номер телефона:</p>
							<span class="main__phone" id="phone"><?php echo ($phone)?></span>
						</div>
					</div>
					<img class="main__top-image" src="https://afcnt.com/affconfirm/order.png" alt="">
				</div>
				<div class="main__bottom">
					<div class="main__bottom-items">
						<div class="main__bottom-item">
							<p class="main__bottom-text">В ближайшее время с вами свяжется менеджер, подтвердит наличие товара и ответит на вопросы</p>
							<img class="main__bottom-image" src="https://afcnt.com/affconfirm/order-icon-1.svg" alt="">
						</div>
						<div class="main__bottom-item">
							<p class="main__bottom-text">Далее мы бережно упакуем ваш заказ и передадим в службу доставки, которую вы выберете в процессе оформления заказа</p>
							<img class="main__bottom-image" src="https://afcnt.com/affconfirm/order-icon-2.svg" alt="">
						</div>
						<div class="main__bottom-item">
							<p class="main__bottom-text">Оплатить товар можно при получении</p>
	...
	<footer class="footer">
		<div class="container">
			<h2 class="footer__title">Благодарим за заказ!</h2>
		</div>
	</footer>
